...
public class PoliceStructureController {
    ...
    @PostMapping
    public ResponseEntity<?> add(@RequestBody PoliceStructureRequest policeStructureRequest) {
        policeStructureService.add(policeStructureRequest);
        return ResponseEntity.ok("Police structure " +
                policeStructureRequest.getStructureName() +
                " added successfully !");
    }
}
